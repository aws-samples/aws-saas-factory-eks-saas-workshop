...
exports.handler = async function (event, context) {
  ...
  try {
    ...
    // deploys our CDK app, specifically the EKS Cluster.
...
exports.handler = async function (event, context) {
  ...
  if (event['detail']['build-status'] === 'SUCCEEDED') {
    ...
    const rootStack = new cdk.CustomResource(this, 'RootStack', {
      serviceToken: startBuildFunction.functionArn,
      properties: {
        ProjectName: buildProject.projectName,
        WSParticipantRoleArn: teamRoleArn.valueAsString,
    ...
    rootStack.node.addDependency(buildCompleteRule, buildProjectPolicy, vpc);
  }
}
